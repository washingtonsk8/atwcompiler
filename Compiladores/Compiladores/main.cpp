...
void CODE_GENERATOR_T(){
	...
	_c.insertCodeToWrite("ADI ");
	_c.insertCodeToWrite("A, ");
	_c.insertCodeToWrite("B\n");
	_c.insertCodeToWrite("LOD A, #10(DS)\n");
	_c.insertCodeToWrite("ADD ", 10, true);
	_c.insertCodeToWrite("A, ", 11, true);
	_c.insertCodeToWrite("#10\n", 12, true);
	_c.insertCodeToWrite("LOD A, #10(DS)\n");
	_c.insertCodeToWrite("LOD B, #12(DS)\n");
	_c.insertCodeToWrite("ADD ", 22, true);
	_c.insertCodeToWrite("A B\n", 23, true);
	_c.flush();
	_c.insertCodeToWrite("SBI ");
	_c.insertCodeToWrite("A, ");
	_c.insertCodeToWrite("B\n");
	_c.insertCodeToWrite("LOD A, #10(DS)\n");
	_c.insertCodeToWrite("SUB ", 10, true);
	_c.insertCodeToWrite("A, ", 11, true);
	_c.insertCodeToWrite("#10\n", 12, true);
	_c.insertCodeToWrite("LOD A, #10(DS)\n");
	_c.insertCodeToWrite("LOD B, #12(DS)\n");
	...
	_c.insertCodeToWrite("LOD B, #12(DS)\n");
	_c.insertCodeToWrite("ADD ", 22, true);
	_c.insertCodeToWrite("A B", 23, true);
	_c.flush();
	_c.dispose(0, NULL);
}
/*CODE GENERATOR MODULE TESTS*/
...
void _RunCompiler(int argc, char* argv[], char* envp[]){
	...
	void* _SuperArg[2] = {"symbols.txt", "teste1.gl"};
